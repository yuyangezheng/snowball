...
const SearchDrawingllUser = ({ placeholder = "0xf" }) => {
  ...
  return (
    <div className={styles.container}>
      <h1>Find Approved Operators by Creator for Drawing Contract</h1>
      ...
      <div className={styles.container}>
        {operators.length > 0 ? (
          ...
          <div className={styles.noOperatorsMessage}>
            <h2>No Approved Operators</h2>
          </div>
        )}
      </div>
...
export default SearchDrawingllUser;
